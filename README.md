...
# GPCRDB client generated by swagger

```
wget http://repo1.maven.org/maven2/io/swagger/swagger-codegen-cli/2.1.4/swagger-codegen-cli-2.1.4.jar 
java -jar swagger-codegen-cli-2.1.4.jar generate -i http://gpcrdb.org/services/reference/api-docs/ -l java -o nl.esciencecenter.e3dchem.gpcrdb.client
```

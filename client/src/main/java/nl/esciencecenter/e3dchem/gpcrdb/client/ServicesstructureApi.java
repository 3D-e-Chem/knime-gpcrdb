...
public class ServicesstructureApi {
    ...
    private com.squareup.okhttp.Call structureSingleProteinGETCall(String entryName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        // create path and map variables
        String localVarPath = "/services/structure/protein/{entry_name}/?single".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "entry_name" + "\\}", apiClient.escapeString(entryName.toString()));
    ...
    public ApiResponse<Structure> structureSingleProteinGETWithHttpInfo(String entryName) throws ApiException {
        com.squareup.okhttp.Call call = structureSingleProteinGETCall(entryName, null, null);

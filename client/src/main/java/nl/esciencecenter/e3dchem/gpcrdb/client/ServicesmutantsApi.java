...
public class ServicesmutantsApi {
     ...
     */
    public com.squareup.okhttp.Call mutantListGETCall(String entryName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/services/mutants/{entry_name}/"
    ...
    private com.squareup.okhttp.Call mutantListGETValidateBeforeCall(String entryName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<MutationSerializer>> mutantListGETWithHttpInfo(String entryName) throws ApiException {
        com.squareup.okhttp.Call call = mutantListGETValidateBeforeCall(entryName, null, null);
    ...
    public com.squareup.okhttp.Call mutantListGETAsync(String entryName, final ApiCallback<List<MutationSerializer>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = mutantListGETValidateBeforeCall(entryName, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<MutationSerializer>>(){}.getType();
